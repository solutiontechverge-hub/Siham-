...
export type ProfessionalProfileMenuPopoverProps = {
...
export default function ProfessionalProfileMenuPopover({
  anchorEl,
  open,
  onClose,
  name,
  email,
  avatarSrc,
}: ProfessionalProfileMenuPopoverProps) {
  ...
  return (
    ...
    >
      <Stack spacing={2}>
        ...
        <Button component={Link} href="/professionals/profile" variant="outlined" fullWidth sx={outlinedBtnSx} onClick={onClose}>
          Profile
        </Button>
        <Button component={Link} href="/professionals/calendar" variant="outlined" fullWidth sx={outlinedBtnSx} onClick={onClose}>
          Calendar
        </Button>
        <Button component={Link} href="/professionals/finance/overview" variant="outlined" fullWidth sx={outlinedBtnSx} onClick={onClose}>
          Finance
        </Button>
        <Button component={Link} href="/professionals/analytics" variant="outlined" fullWidth sx={outlinedBtnSx} onClick={onClose}>
          Analytics
        </Button>
