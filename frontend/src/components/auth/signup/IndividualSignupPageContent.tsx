...
import { individualSignupData } from "../../../app/auth/signup/individual/individualSignup.data";
...
const initialForm: FormState = individualSignupData.initialForm;

export default function IndividualSignupPageContent() {
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={4}>
                          ...
                          >
                            ...
                            {individualSignupData.countryCodes.map((code) => (
