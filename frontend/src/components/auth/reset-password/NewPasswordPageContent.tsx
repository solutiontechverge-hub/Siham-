...
import { MarketingSiteHeader, MollureLabeledPasswordField } from "../../common";
                ...
                <Box component="form" onSubmit={handleSubmit}>
                  <Stack spacing={2}>
                    ...
                    <BodyText textAlign="center" sx={{ color: alpha(m.navy, 0.48), fontSize: "0.8125rem" }}>
                      <Link href="/auth/reset-password/verify-otp" style={{ color: m.teal, textDecoration: "none", fontWeight: 600 }}>
