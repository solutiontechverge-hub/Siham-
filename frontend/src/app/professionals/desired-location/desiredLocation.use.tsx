...
export type DesiredLocationFormState = {
  profileName: string;
  about: string;
  keywordDraft: string;
  keywords: string[];

  // Desired Location (mirrors Fixed Location for now)
  salonName: string;
...
const initialState: DesiredLocationFormState = {
  profileName: "",
  about: "",
  keywordDraft: "",
  keywords: [],
...
export function useDesiredLocationForm() {
  const [values, setValues] = React.useState<DesiredLocationFormState>(initialState);

  const setField = React.useCallback(
    <K extends keyof DesiredLocationFormState>(key: K, value: DesiredLocationFormState[K]) => {
  ...
  const setServiceFor = React.useCallback(
