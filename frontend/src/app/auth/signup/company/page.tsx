  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      showSnackbar({
        ...
        message:
          result.message ||
          "Company account created successfully. Please check your email.",
      });
      setForm(initialForm);
    } catch (error) {
      showSnackbar({
            ...
            >
              <Stack spacing={4}>
                ...
                <Box component="form" onSubmit={handleSubmit}>
                  <Stack spacing={4}>
                    <Box>
                      <SubHeading sx={{ mb: 2, fontSize: "1.125rem", color: "#10233f" }}>Company Information</SubHeading>
                    ...
                    <Box>
                      <SubHeading sx={{ mb: 2, fontSize: "1.125rem", color: "#10233f" }}>Contact Person</SubHeading>
                      <Grid container spacing={2.5}>
                        <Grid item xs={12} md={6}>
                          <TextField
                            fullWidth
